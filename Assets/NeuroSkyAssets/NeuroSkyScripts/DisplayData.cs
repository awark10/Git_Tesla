...
public class DisplayData : MonoBehaviour {
   ...
   public void OnAlgo_UpdateMeditationEvent(int value)
	...
	void OnUpdateAttention(int value){
        int curval = Attention;

        Attention = value;
        conSlider.value = Mathf.Lerp(Attention, curval, Time.deltaTime);
    }
	void OnUpdateMeditation(int value){
        int curval = Meditation;
		Meditation = value;

        medSlider.value = Mathf.Lerp(Meditation, curval, Time.deltaTime);
            }
